...
export class AddTableUsersCompanyLocations1745682386980
  implements MigrationInterface
{
  name = 'AddTableUsersCompanyLocations1745682386980';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "locations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "zip_code" text NOT NULL, "bulevar" text NOT NULL, "number" text NOT NULL, "district" text NOT NULL, "city" text NOT NULL, "state" text NOT NULL, "companyId" uuid NOT NULL, CONSTRAINT "PK_7cc1c9e3853b94816c094825e74" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "website" text NOT NULL, "cnpj" text NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "UQ_703760d095b8e399e34950f4960" UNIQUE ("cnpj"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
